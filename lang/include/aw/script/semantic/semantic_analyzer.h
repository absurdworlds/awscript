...
private:
	...
	void visit_expr(context& ctx, middle::chain_expression& expr);
	...
	auto infer_type(context& ctx, middle::chain_expression& expr) -> ir::type*;
	...
	auto propagate_type(context& ctx, ir::type* type, middle::chain_expression& expr) -> ir::type*;
