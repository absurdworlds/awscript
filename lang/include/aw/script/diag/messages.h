...
DIAG(error, is_not_a_struct_type, "Left-hand side of the ‘.’ operator is not a struct type.")
DIAG(error, is_not_an_array_type, "Left-hand side of the ‘.’ operator is not an array type.")
DIAG(error, identifier_required, "Right-hand side of the ‘.’ operator must be an identifier.")
DIAG(error, mixed_initializer, "Mixing different kinds of initializers is not allowed.")
...
DIAG(error, not_allowed_here, "‘%0’ declaration is not allowed here.")
